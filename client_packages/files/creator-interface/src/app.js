...
const data = { 
   faceFeatures: [
      'Nasenbreite', 'Nasenhöhe', 'Nasenlänge', 'Nase - Stegbreite', 'Nase - Position', 
      'Nasenrücken bewergen', 'Breite der Augenbrauen', 'Breite der Augenbrauen', 'Wangenknochenhöhe', 
      'Wangenknochenbreite', 'Wangenbreite', 'Augen', 'Lippen', 'Kieferlänge', 'Gabelhöhe', 
      'Bartlänge', 'Kinnstellung', 'Kinnbreite', 'Bartform',  'Türbreite', 
   ],
   ...
   headOverlays: ['Flecken', 'Augenbrauen', 'Alter', 'Bilden', 'Errötungen', 'Teint', 'Sonnenschaden', 'Lippenstift', 'Sommersprossen', 'Brustbehaarung'],
   ...
   clothings: ['Torso', 'T-Shirt', 'Hose', 'Schuhe'], 
   clothingMax: [361, 132, 97],

   blendData: [ 
      ['Gesichtsform Mutter', 0, 45, 1], ['Gesichtsform Vater', 0, 45, 1], ['Hautfarbe Mutter', 0, 45, 1],
      ['Hautfarbe Vater', 0, 45, 1], ['Vermischung Gesichter', -1, 1, 0.1], ['Vermischung Hautfarbe',-1, 1, 0.1]
   ]
}
