! function(e) {
    ...
    class u {
        ...
        static Parse(e) {
            if ("object" == typeof e) {
                if (e.length) return new u(e[0], e[1]);
                if (e.X && e.Y) return new u(e.X, e.Y)
            } else if ("string" == typeof e && -1 !== e.indexOf(",")) {
                const t = e.split(",");
                return new u(parseFloat(t[0]), parseFloat(t[1]))
            }
            return new u(0, 0)
        }
    }
    ...
    class T {
        ...
        SelectItem() {
            ...
            const e = this.MenuItems[this.CurrentSelection];
            if (this.MenuItems[this.CurrentSelection] instanceof w) e.Checked = !e.Checked, R.PlaySound(this.AUDIO_SELECT, this.AUDIO_LIBRARY), this.onCheckboxChange.emit(e, e.Checked);
            else if (R.PlaySound(this.AUDIO_SELECT, this.AUDIO_LIBRARY), this.onItemSelect.emit(e, this.CurrentSelection), this.Children.has(e)) {
                const t = this.Children.get(e);
                this.Visible = !1, t.Visible = !0, this.onMenuChange.emit(t, !0)
            }
            e.fireEvent()
        }
